...
TEST_F(Simulacion_Test, cumplir_objetivos) {
	...
	s1.mover(DERECHA); // 4,5 -> 5,5
	s1.mover(DERECHA); // 5,5 -> 6,5
	s1.mover(ARRIBA); // 6,5 -> 6,6
	s1.mover(ARRIBA);  // 6,6 -> 6,7
	s1.mover(IZQUIERDA); // 6,7 -> 5,7
